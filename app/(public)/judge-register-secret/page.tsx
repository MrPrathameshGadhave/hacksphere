  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (loginResponse.data?.success) {
        ...
        toast.success("Judge account created successfully. Please login.");
        router.push("/login");
      }
    } catch (error: any) {
      toast.error(
          ...
          <div className="relative z-10 flex w-full flex-col justify-between px-10 py-12 xl:px-14">
            ...
            <div className="max-w-xl">
              <div className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm text-white/90 backdrop-blur-sm">
                Restricted Judge Registration
              </div>

              <h2 className="mt-6 text-4xl font-bold leading-tight text-white xl:text-5xl">
                Create your official judge account for HackSphere.
              </h2>

              <p className="mt-6 text-lg leading-8 text-white/85">
                This private registration portal is reserved for authorized judges.
                Access requires a valid judge code issued by the organizing team.
              </p>
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-center gap-4 rounded-2xl bg-white/10 px-4 py-3 backdrop-blur-sm">
                  ...
                  <p className="text-base font-medium text-white">
                    Review assigned submissions fairly and securely
                  </p>
                </div>
                ...
                <div className="flex items-center gap-4 rounded-2xl bg-white/10 px-4 py-3 backdrop-blur-sm">
                  ...
                  <p className="text-base font-medium text-white">
                    Score projects by innovation, impact, and technical strength
                  </p>
                </div>
                ...
                <div className="flex items-center gap-4 rounded-2xl bg-white/10 px-4 py-3 backdrop-blur-sm">
                  ...
                  <p className="text-base font-medium text-white">
                    Judge workflow managed under TechTitans authorization
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-xs tracking-wide text-white/65">
              HACKSPHERE • TECHTITANS • PRIVATE JUDGE ACCESS
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-lg rounded-[28px] border border-[#ececec] bg-white p-8 shadow-[0_12px_40px_rgba(0,0,0,0.06)] sm:p-10">
            <div className="mb-8 text-center">
              ...
              <p className="mt-3 text-base text-gray-500">
                Authorized judges can create their account using the issued access code.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <label className="flex items-start gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-600">
                ...
                />
                <span>
                  I agree to follow HackSphere judging rules, evaluation ethics,
                  confidentiality guidelines, and review responsibilities.
                </span>
              </label>
