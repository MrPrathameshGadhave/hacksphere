...
export default function JudgeRegisterSecretPage() {
  ...
  const [formData, setFormData] = useState<JudgeRegisterFormData>({
    name: "",
    email: "",
    college: "",
    accessCode: "",
  ...
  const validateForm = () => {
    ...
    if (!formData.accessCode.trim()) {
      toast.error("Judge access code is required");
      return false;
    }
    ...
    if (!formData.agreeToTerms) {
      toast.error("Please accept the judge terms and evaluation guidelines");
      return false;
    }
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const signupResponse = await axios.post("/api/auth/signup/judge", {
      ...
      if (!signupResponse.data?.success) {
        toast.error(signupResponse.data?.message || "Judge registration failed");
        return;
      }
  ...
  return (
    <PublicAuthShell
      eyebrow="Restricted Judge Access"
      title="Create your verified judge workspace."
      description="Authorized judges can onboard securely, wait for approval, and move into the official HackSphere evaluation flow with the same polished experience as the rest of the platform."
      highlights={[
        {
          title: "Structured Review Workflow",
          text: "Evaluate assigned submissions through a clear rubric-driven experience built for consistent judging.",
          icon: ClipboardCheck,
        },
        {
          title: "Fair Scoring Standards",
          text: "Score innovation, execution, impact, and presentation quality with organized review controls.",
          icon: Scale,
        },
        {
          title: "Approval-Gated Access",
          text: "Only organizer-authorized judges are activated, keeping the evaluation pipeline protected.",
          icon: ShieldCheck,
        },
      ]}
    >
      <div className="w-full max-w-xl rounded-[30px] border border-[#eadfe3] bg-white/92 p-8 shadow-[0_16px_48px_rgba(74,36,48,0.08)] sm:p-10">
        <div className="mb-8 text-center">
          ...
          <p className="mt-3 text-base leading-7 text-gray-500">
            Create your judge account using the issued access code. New judge
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Enter authorized judge code"
          ...
          <label className="flex items-start gap-3 rounded-2xl border border-gray-200 bg-[#fcfafb] px-4 py-3 text-sm text-gray-600">
            ...
            />
            <span>
              I agree to follow HackSphere judging rules, confidentiality
              expectations, and evaluation ethics throughout the review process.
            </span>
          </label>
          ...
          >
            {loading ? "Creating Judge Account..." : "Create Judge Account"}
        ...
        <div className="mt-8 space-y-4 text-center">
          ...
          <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
            Judge access is activated only after admin approval.
          </div>
        </div>
      </div>
    </PublicAuthShell>
