      ...
      <div className="px-4 pt-5">
        <div className="rounded-2xl bg-gradient-to-br from-[#A01C33] to-[#7e1528] p-4 text-white shadow-[0_12px_28px_rgba(160,28,51,0.22)]">
          ...
          <h2 className="mt-2 text-lg font-semibold leading-6">
            Build your project. Lead your team. Rise on the leaderboard.
          </h2>
        </div>
      </div>
...
export default function ParticipantSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-[290px] flex-col border-r border-gray-200 bg-white shadow-[0_20px_60px_rgba(0,0,0,0.18)] transition-transform duration-300 ease-in-out lg:hidden",
